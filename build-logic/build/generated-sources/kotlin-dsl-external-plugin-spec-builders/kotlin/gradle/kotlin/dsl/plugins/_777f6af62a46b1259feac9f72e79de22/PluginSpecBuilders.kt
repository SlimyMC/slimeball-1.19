...
package gradle.kotlin.dsl.plugins._777f6af62a46b1259feac9f72e79de22
...
/**
 * The `net.kyori` plugin group.
 */
@org.gradle.api.Generated
internal
class `NetKyoriPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `net.kyori`.
 */
internal
val `NetPluginGroup`.`kyori`: `NetKyoriPluginGroup`
    get() = `NetKyoriPluginGroup`(plugins)


/**
 * The `net.kyori.indra` plugin implemented by [net.kyori.indra.IndraPlugin].
 */
internal
val `NetKyoriPluginGroup`.`indra`: PluginDependencySpec
    get() = plugins.id("net.kyori.indra")
...
/**
 * The `org.graalvm` plugin group.
 */
@org.gradle.api.Generated
internal
class `OrgGraalvmPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `org.graalvm`.
 */
internal
val `OrgPluginGroup`.`graalvm`: `OrgGraalvmPluginGroup`
    get() = `OrgGraalvmPluginGroup`(plugins)


/**
 * The `org.graalvm.buildtools` plugin group.
 */
@org.gradle.api.Generated
internal
class `OrgGraalvmBuildtoolsPluginGroup`(internal val plugins: PluginDependenciesSpec)


/**
 * Plugin ids starting with `org.graalvm.buildtools`.
 */
internal
val `OrgGraalvmPluginGroup`.`buildtools`: `OrgGraalvmBuildtoolsPluginGroup`
    get() = `OrgGraalvmBuildtoolsPluginGroup`(plugins)


/**
 * The `org.graalvm.buildtools.native` plugin implemented by [org.graalvm.buildtools.gradle.NativeImagePlugin].
 */
internal
val `OrgGraalvmBuildtoolsPluginGroup`.`native`: PluginDependencySpec
    get() = plugins.id("org.graalvm.buildtools.native")
